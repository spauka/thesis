...
\end{equation}
For the left wall gate studied previously, a change of $\Delta V_\textrm{SD} = \SI{2.8}{\volt\per\volt}$ is observed, as shown in Fig.~\ref{fig:gbcorr} (b). Again, this effect may be trivially compensated prior to the locking of a charge on a gate by selecting a fixed value of $V_\textrm{HOLD}$ during the operation of the qubit device.
