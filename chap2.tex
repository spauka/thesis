...
qubits, have been able to sidestep the issues associated with such power dissipation at the various temperatures of the cryostat, moving past as few as 20 qubits quickly
becomes inpractical. This can be seen if one considers the typical cooling power of various stages of a cryostat. Using the BlueFors LD-400 system\footnote{
Datasheet available at: \url{https://bluefors.com/products/ld-dilution-refrigerator/}} as an example of a typical dilution refrudgerator, and using
a Cryomech PT420 pulse tube cryocooler\footnote{Datasheet available at: \url{https://www.cryomech.com/cryocoolers/pulse-tube-cryocoolers}} for cooling
...
\begin{figure}
  ...
  of the fast control multiplexing device. The chip has dimensions $2.5\times2.5\si{\milli\meter}$. (c)Block diagram of }
\end{figure}


In this section, we propose a CryoCMOS based architecture to reduce the wiring requirements and power dissipation at the lowest stages of a dilution refridgerator.
