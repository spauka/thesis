...
\begin{figure}
    ...
    \caption{\label{fig:surf_cmos} (a) Schematic of a single cell of the multiplexing chip. Each input is multiplexed to 5 outputs, allowing for a total of 160 DC lines to be measured using 32 lines. (b) Image of the multiplexing chip. (c) Mounted measurement board, with four samples mounted around the bottom of the board.}
\end{figure}
...
\begin{figure}
    ...
    \caption{\label{fig:surf_mobden} The density at which the peak mobility occurs for all samples near the center of the growth wafer. Samples grown with ozone are shifted to the right relative to samples grown with water.}
\end{figure}
